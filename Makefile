...
MY_LIB = ./my_lib
LIB = ./my_lib/my_lib.a
SRC = ./Mandatory/push_swap.c ./Mandatory/check_ft.c ./Mandatory/operations.c ./Mandatory/sort_ft.c ./Mandatory/sort_ft_utils.c ./Mandatory/commands_a.c ./Mandatory/commands_b.c ./Mandatory/commands_ab.c ./Mandatory/big_sort_utils.c
